...
// Gaphics cmb CD logo on and off 
#include <Arduino.h>  // PROGMEM support header
#define logoWidth  25  // logo width
#define logoHeight 28  // logo height

// Image is stored in this array
PROGMEM const unsigned char SDok[] = {
  0x00, 0x00, 0x00, 0x00, 0xFC, 0xFF, 0x01, 0x00, 0xFE, 0xFF, 0x03, 0x00, 
  0xFE, 0xFF, 0x07, 0x00, 0x46, 0x24, 0x0E, 0x00, 0x46, 0x24, 0x1E, 0x00, 
  0x46, 0x24, 0x3E, 0x00, 0x46, 0x24, 0x7E, 0x00, 0xEE, 0x77, 0xFF, 0x00, 
  0xFE, 0xFF, 0xFF, 0x00, 0xFE, 0xFF, 0xFF, 0x00, 0xFE, 0xFF, 0xFF, 0x00, 
  0xFC, 0xFF, 0xFF, 0x00, 0xFC, 0xFF, 0xFF, 0x00, 0xFC, 0xFF, 0xFF, 0x00, 
  0xFC, 0xFF, 0xFF, 0x00, 0xFC, 0xFF, 0x7F, 0x00, 0xFC, 0xFF, 0x7F, 0x00, 
  0xFC, 0xFF, 0x7F, 0x00, 0xFE, 0xFF, 0x7F, 0x00, 0xFE, 0xFF, 0xFF, 0x00, 
  0xFE, 0xFF, 0xFF, 0x00, 0xFE, 0xFF, 0xFF, 0x00, 0xFE, 0xFF, 0xFF, 0x00, 
  0xFE, 0xFF, 0xFF, 0x00, 0xFE, 0xFF, 0xFF, 0x00, 0xFC, 0xFF, 0x7F, 0x00, 
  0x00, 0x00, 0x00, 0x00, };

// Image is stored in this array
PROGMEM const unsigned char SDno[] = {
  0x00, 0x00, 0x00, 0x00, 0xFC, 0xFF, 0x81, 0x01, 0xFE, 0xFF, 0xC3, 0x01, 
  0xFE, 0xFF, 0xE7, 0x00, 0x46, 0x04, 0x72, 0x00, 0x46, 0x24, 0x3A, 0x00, 
  0x46, 0x20, 0x18, 0x00, 0x46, 0x24, 0x6C, 0x00, 0xEE, 0x6F, 0xFE, 0x00, 
  0xFE, 0x3F, 0xF7, 0x00, 0xFE, 0x9F, 0xFF, 0x00, 0xFE, 0xCF, 0xFD, 0x00, 
  0xFC, 0xC7, 0xFE, 0x00, 0xFC, 0x73, 0xFF, 0x00, 0xFC, 0xFB, 0xFF, 0x00, 
  0xFC, 0xD8, 0xFF, 0x00, 0xFC, 0xEC, 0x7F, 0x00, 0x7C, 0xFE, 0x7F, 0x00, 
  0x3C, 0xFB, 0x7F, 0x00, 0x9E, 0xFF, 0x7F, 0x00, 0xCE, 0xFF, 0xFF, 0x00, 
  0xEE, 0xFE, 0xFF, 0x00, 0x72, 0xFF, 0xFF, 0x00, 0xB0, 0xFF, 0xFF, 0x00, 
  0xDC, 0xFF, 0xFF, 0x00, 0xEC, 0xFF, 0xFF, 0x00, 0xF6, 0xFF, 0x7F, 0x00, 
  0x07, 0x00, 0x00, 0x00, };
...
int start=45; // premiere ligne apres header
int curseur = 0; // init 
int page=0; // init
// show a cursor
void ShowCursor(int old, int encours) {
    // cursor delete
  tft.setCursor(5, start+(old*20));
  tft.setTextColor(TFT_BLACK);
  tft.print(">");
  // cursor show
  tft.setCursor(5, start+(encours*20));
